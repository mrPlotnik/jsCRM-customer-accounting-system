(async function() {
  ...
  const fbIcon = '<svg class="fbIcon" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M0 12.067C0 18.0335 4.33333 22.9944 10 24V15.3333H7V12H10V9.33332C10 6.33332 11.9333 4.66666 14.6667 4.66666C15.5333 4.66666 16.4667 4.79999 17.3333 4.93332V7.99999H15.8C14.3333 7.99999 14 8.73332 14 9.66666V12H17.2L16.6667 15.3333H14V24C19.6667 22.9944 24 18.0335 24 12.067C24 5.43017 18.6 0 12 0C5.4 0 0 5.43017 0 12.067Z" fill="#9873FF"/></svg>';
    ...
    function insertDataInRow(obj, clientData) {
      ...
      function getContacts(contacts) {
        ...
        function insertData(obj, arr) {
          ...
          } else if (arr.type === 'other') {
            obj.link.innerHTML = otherIcon;
            obj.link.setAttribute('href', `${arr.value}`);
            tooltip(obj.link, `Другое: <span class="tooltip">${arr.value}</span>` );
          }
  ...
  function createNewContact() {
    ...
    optionOther.innerHTML = `${emailIcon} Другое`;
